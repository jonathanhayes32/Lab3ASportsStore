...
result.ToString());
        ...
        public void Can_Filter_Products()
        {
            ...
            mock.Setup(m => m.Products).Returns(new Product[]
            {
                ...
                new Product {ProductID = 2, Name ="P2", Category = "Cat 2"},
                new Product {ProductID = 3, Name ="P3", Category = "Cat 1"},
                new Product {ProductID = 4, Name ="P4", Category = "Cat 2"},
                new Product {ProductID = 5, Name ="P5", Category = "Cat 3"},
